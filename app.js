...
const translations = {
  en: {
    ...
    traction: {
      ...
      users: 'Saves Hours of Manual Work',
      rating: 'AI That Actually Works',
      reviews: 'Designed for Daily Use',
      platforms: 'Works Everywhere You Do',
    },
    cta: {
  ...
  es: {
    ...
    traction: {
      ...
      users: 'Ahorra Horas de Trabajo Manual',
      rating: 'IA Que Realmente Funciona',
      reviews: 'Diseñado para Uso Diario',
      platforms: 'Funciona Donde Tú Trabajas',
    },
    cta: {
