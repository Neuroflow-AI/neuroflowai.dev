export const translations = {
  es: {
    ...
    hero: {
      ...
      description:
        "Transforma tu empresa con soluciones de IA que generan valor estratégico, optimizan operaciones y potencian tu capacidad de innovación exponencial en mercados dinámicos.",
      cta1: "Comenzar Ahora",
    ...
    features: {
      ...
      subtitle: "Arquitectura cognitiva especializada para acelerar transformación digital empresarial",
  ...
  en: {
    ...
    hero: {
      ...
      description:
        "Transform your business with AI solutions that generate strategic value, optimize operations, and enhance your exponential innovation capacity in dynamic markets.",
      cta1: "Get Started",
      cta2: "View Demo",
      metric1: "98%",
    ...
    features: {
      ...
      subtitle: "Specialized cognitive architecture to accelerate digital business transformation",
